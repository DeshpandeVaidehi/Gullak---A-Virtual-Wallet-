...
<div class="hero-unit">
    ...
    <div class="row-fluid form_contener">
		<div class="span12">
	<form action="SendMoney" method="POST"  name="frmRegister" class="form-horizontal">
	...
	<h2> Pay </h2>
		...
		<div class="control-group">
   		...
   		<div class="control-group">
   	    	<label class="control-label" for="amount"><font color="#FF0000">*</font>Enter the amount to pay : </label>
       		<div class="controls">
		...
		<div class="control-group">
   	    	<label class="control-label" for="note"></font>Message : </label>
       		<div class="controls">
       			<input class="formbox" maxLength="13" id="note" name="note" size="13" value="">
       		</div> 
   		</div>

		<div class="control-group">        		        
                		<div class="controls">
                			<input class="btn btn-warning" type="submit" name="submit" value="Pay">
                		</div> 
        </div>  
